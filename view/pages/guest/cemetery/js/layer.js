...
class LayerManager {
    ...
    // Ensure proper layer ordering (bottom to top): grave-plots -> roads -> annotations
    ensureLayerOrder() {
        try {
            ...
            if (this.map.getLayer('roads') && this.map.getLayer('annotations-fill')) {
                try {
                    ...
                    this.map.moveLayer('annotations-fill', 'annotations');
                    this.map.moveLayer('annotations-fill', 'roads');
                    this.map.moveLayer('annotations-fill', 'grave-plots-fill');
                    this.map.moveLayer('annotations-fill', 'single-grave-plot-fill');
            ...
            //   // Ensure grave plots are at the bottom
            //   if (this.map.getLayer('grave-plots-fill') && this.map.getLayer('roads')) {
            //     this.map.moveLayer('grave-plots-fill', 'roads');
            //     this.map.moveLayer('grave-plots-stroke', 'grave-plots-fill');
            // }
            // // Ensure annotations are above roads and grave plots
            // if (this.map.getLayer('annotations-fill')) {
            //     if (this.map.getLayer('roads')) {
            //         this.map.moveLayer('annotations-fill', 'roads');
            //     }
