...
function editRecord(id) {
    ...
    if (firstRecord) {
        firstRecord.querySelector('.deceased-name').value = record.deceased_name || '';
        firstRecord.querySelector('.date-of-birth').value = record.date_of_birth || '';
        firstRecord.querySelector('.date-of-death').value = record.date_of_death || '';
        firstRecord.querySelector('.burial-date').value = record.burial_date || '';
        firstRecord.querySelector('.grave-layer-number').value = record.grave_layer_number || 1;
        firstRecord.querySelector('.next-of-kin').value = record.next_of_kin || '';
        firstRecord.querySelector('.contact-info').value = record.contact_info || '';
