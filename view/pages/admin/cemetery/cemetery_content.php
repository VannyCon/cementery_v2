             ...
             <div class="card-header">
                ...
                <div class="card-footer">
                        ...
                        <ul class="nav nav-tabs card-header-tabs flex-nowrap" id="managementTabs" role="tablist" style="overflow-x: auto;">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="roads-tab" data-bs-toggle="tab" data-bs-target="#roads" type="button" role="tab">
                                    <i class="fas fa-road me-1"></i>
                                    <span class="d-none d-md-inline">Roads</span>
                                    <span class="d-inline d-md-none">Roads</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="annotations-tab" data-bs-toggle="tab" data-bs-target="#annotations" type="button" role="tab">
                                    <i class="fas fa-sticky-note me-1"></i>
                                    <span class="d-none d-md-inline">Annotations</span>
                                    <span class="d-inline d-md-none">Notes</span>
                                </button>
                            </li>
                            <!-- <li class="nav-item" role="presentation">
                                <button class="nav-link" id="plots-tab" data-bs-toggle="tab" data-bs-target="#plots" type="button" role="tab">
                                    <i class="fas fa-square me-1"></i>
                                    <span class="d-none d-md-inline">Grave Plots</span>
                                    <span class="d-inline d-md-none">Plots</span>
                                </button>
                            </li> -->
                        </ul>
                    </div>
                    <div class="tab-content" id="managementTabsContent">
                        <!-- Cemeteries Tab -->
                        <!-- <div class="tab-pane fade show active" id="cemeteries" role="tabpanel">
                            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-3 gap-2">
                                <h5 class="mb-0">Cemetery Locations</h5>
                                <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#cemeteryModal" onclick="openCemeteryModal()">
                                    <i class="fas fa-plus me-1"></i>Add Cemetery
                                </button>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="cemeteriesTable">
